...
from Plugins.Extensions.NssUtill.CamEx import NSSCamsManager
...
def GetSkinPath():
    ...
    myskinpath = '/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/'
    return myskinpath
...
class NssMenu(Screen):
    ...
    <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/icons/logo.png" position="245,0" size="711,76" alphatest="on" />
...
class ListaFile(Screen):
    ...
    <ePixmap position="116,532" size="34,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_red.png" alphatest="on" />
    <ePixmap position="342,532" size="32,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_green.png" alphatest="on" />
...
class ManualInstall(Screen):
    ...
    <ePixmap position="116,532" size="34,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_red.png" alphatest="on" />
    <ePixmap position="342,532" size="32,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_green.png" alphatest="on" />
    <ePixmap position="572,532" size="34,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_yellow.png" alphatest="on" />
    <ePixmap position="807,532" size="34,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_blue.png" alphatest="on" />
    <widget name="key_red" position="147,535" zPosition="1" size="209,40" font="Regular;30" halign="center" valign="center" backgroundColor="#009f1313" transparent="1" />
    <widget name="key_green" position="373,535" zPosition="1" size="209,40" font="Regular;30" halign="center" valign="center" backgroundColor="#009f1313" transparent="1" />
