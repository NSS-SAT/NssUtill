...
plugin_path = '/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/'
cccaminfo = False
...
class NSSCamsManager(Screen):
    ...
    if HD_Res == True:
        ...
        <ePixmap name="red" position="116,532" zPosition="2" size="34,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_red.png" transparent="1" alphatest="on" />
        <ePixmap name="green" position="342,532" zPosition="2" size="34,47" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/NssUtill/buttons/key_green.png" transparent="1" alphatest="on" />
